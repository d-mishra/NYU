...
#plt.plot(unix_xval, unix_vals)
plt.plot(unix_xval,unix_count)
plt.show()

#2.Database
#db_vals = [3, 4, 5, 4, 3] #change to db1_count...
db_xval = [1, 2, 3, 4, 5]
#plt.plot(db_xval, db_vals)
plt.plot(db_xval, db_count)
plt.show()

#2.Programming
#pro_vals = [10, 9, 8, 5, 7] #change to pro1_count...
prog_xval = [1, 2, 3, 4, 5]
#plt.plot(pro_xval, pro_vals)
...
#4.bar plot
#plt.bar(unix_xval,unix_count,db_xval,db_count,prog_xval,prog_count)
